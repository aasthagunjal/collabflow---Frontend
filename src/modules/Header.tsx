...
import { Search, Phone, Info, Hash, Lock } from 'lucide-react';
        ...
        {currentView === 'chat' ? (
          <>
            ...
            <button
              ...
              className={`w-8 h-8 flex items-center justify-center rounded-lg active:scale-95 transition-all ${infoPaneOpen ? 'bg-primary-container text-white' : 'hover:bg-[#eff4ff] text-secondary'
                }`}
            >
